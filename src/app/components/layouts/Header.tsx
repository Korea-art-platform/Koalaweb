...
export function Header() {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 transition-all duration-300 z-50 ${navBgClass}`}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4 md:gap-6">
              <button
                ...
                aria-label="검색"
                className={`z-[120] ${iconButtonClass} ${iconClass}`}
              >
