...
import { LayoutDashboard, Package, Tags, Users, ShoppingBag, Star, Image as ImageIcon, RotateCcw, Bell, MessageCircle, Wallet, Store, Wrench, Frame } from 'lucide-react';
  ...
  const navGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: '전시회', path: '/admin/exhibition', icon: Frame },
      ],
    },
    {
      title: '정산',
