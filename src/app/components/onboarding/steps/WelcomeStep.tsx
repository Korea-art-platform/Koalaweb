...
export default function WelcomeStep({ onNext }: { onNext: () => void }) {
  ...
  return (
    <div className="bg-white rounded-3xl p-12 shadow-sm border border-gray-100 text-center animate-in fade-in zoom-in-95 duration-500">
      ...
      <h1 className="text-4xl font-medium tracking-tight mb-4">{t('auth.onboarding.welcome.title')}</h1>
      <p className="text-gray-400 leading-relaxed mb-8 max-w-md mx-auto">{t('auth.onboarding.welcome.desc')}</p>
