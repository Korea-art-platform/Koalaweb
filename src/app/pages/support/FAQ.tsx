...
const FAQS: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '현금영수증은 결제 완료 후 고객센터(support@koala-art.co.kr)로 요청 시 발급 가능합니다. 사업자 세금계산서는 현재 별도 문의 부탁드립니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: '상품 수령 후 7일 이내에 마이페이지 > 주문 내역에서 신청하거나 고객센터(support@koala-art.co.kr)로 문의해 주세요. 상품 상태 확인 후 처리 안내를 드립니다.',
      },
      {
        q: '환불은 언제 처리되나요?',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: '파트너십 문의 페이지 또는 partnership@koala-art.co.kr로 포트폴리오와 함께 연락 주시면 검토 후 안내드리겠습니다.',
      },
    ],
  },
];
